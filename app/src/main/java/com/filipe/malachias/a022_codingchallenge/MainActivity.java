package com.filipe.malachias.a022_codingchallenge;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == ITEMS_REQUEST) {
            if (resultCode == RESULT_OK) {
                // data
                ArrayList<String> items = data.getExtras().getStringArrayList(Main2Activity.ITEMS_EXTRA);
    ...
    //    outState.putStringArrayList("List", Main2Activity.ITEMS_EXTRA);
    //}
}